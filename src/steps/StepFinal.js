  ...
  const submitData = token => {
    ...
    return (
      <div>
        ...
        <Panel heading={__('Registrácia dokončená', 'ehranica')} body={bodyText} />
        <InsetText content={__('Ak cestujete na Slovensko letecky, musíte taktiež vyplniť formulár na stránke <a href="https://www.mindop.sk/covid-19" target="_blank" class="govuk-link">mindop.sk/covid-19</a>.', 'ehranica')} />
        <WarningText content={__('V prípade že prichádzate z <a href="">týchto</a> krajín letecky, musíte mať negatívny 72-hodín starý PCR test.', 'ehranica')} />
